...
const Note = defineNoteConfig({
  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        //站点配置
        { text: "站点配置", link: "config-usage/", icon: "ri:global-line" },
        //字体配置
...

    {
      ...
      items: [
        ...
        {
          text: "Halo迁移",
          link: "halo-to-Firefly/",
          icon: "ri:exchange-line",
        },
        {
          text: "Hexo迁移",
          link: "hexo-to-Firefly/",
          icon: "ri:exchange-line",
        },
        { text: "HTML导入", link: "html-import/", icon: "ri:html5-line" },
        {
          text: "Hugo迁移",
          link: "hugo-to-Firefly/",
          icon: "ri:exchange-line",
        },
        {
          text: "Jekyll迁移",
          link: "jekyll-to-Firefly/",
          icon: "ri:exchange-line",
        },
        {
          text: "Markdown导入",
        ...
        {
          text: "Typecho迁移",
          link: "typecho-to-Firefly/",
          icon: "ri:exchange-line",
        },
        {
          text: "WordPress迁移",
          link: "wordpress-to-Firefly/",
